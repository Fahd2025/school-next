...
CREATE TABLE "Student" (
    ...
    CONSTRAINT "Student_classId_fkey" FOREIGN KEY ("classId") REFERENCES "Class" ("id") ON DELETE NO ACTION ON UPDATE NO ACTION,
    CONSTRAINT "Student_gradeId_fkey" FOREIGN KEY ("gradeId") REFERENCES "Grade" ("id") ON DELETE NO ACTION ON UPDATE NO ACTION
);
...
CREATE TABLE "Lesson" (
    ...
    CONSTRAINT "Lesson_classId_fkey" FOREIGN KEY ("classId") REFERENCES "Class" ("id") ON DELETE NO ACTION ON UPDATE NO ACTION,
...
CREATE TABLE "Result" (
    ...
    CONSTRAINT "Result_examId_fkey" FOREIGN KEY ("examId") REFERENCES "Exam" ("id") ON DELETE NO ACTION ON UPDATE NO ACTION,
    CONSTRAINT "Result_assignmentId_fkey" FOREIGN KEY ("assignmentId") REFERENCES "Assignment" ("id") ON DELETE NO ACTION ON UPDATE NO ACTION,
    CONSTRAINT "Result_studentId_fkey" FOREIGN KEY ("studentId") REFERENCES "Student" ("id") ON DELETE NO ACTION ON UPDATE NO ACTION
);
...
CREATE TABLE "Attendance" (
    ...
    "studentId" TEXT NOT NULL,
    "lessonId" INTEGER NOT NULL,
    CONSTRAINT "Attendance_studentId_fkey" FOREIGN KEY ("studentId") REFERENCES "Student" ("id") ON DELETE NO ACTION ON UPDATE NO ACTION,
    CONSTRAINT "Attendance_lessonId_fkey" FOREIGN KEY ("lessonId") REFERENCES "Lesson" ("id") ON DELETE NO ACTION ON UPDATE NO ACTION
);
